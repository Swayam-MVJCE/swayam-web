  ...
  return (
    <MainLayout>
      <div className="flex flex-col gap-20 px-4 md:px-16 md:py-10 pb-6">
        <div className="flex min-h-[60vh] flex-col md:flex-row items-center gap-4 justify-center md:justify-around">
          <div className="flex w-full basis-3/5 flex-col gap-2 justify-center md:justify-start">
            ...
            <p className="font-satoshi text-gray-300 max-w-xl">
              {`
        ...
        <div className="flex min-h-[60vh] flex-col md:flex-row items-center justify-center md:justify-around w-full">
          <Image
            ...
            height={500}
          />
          <div className="flex basis-2/5 flex-col gap-4 justify-start">
